  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}> {/* // gap вместо spacing */}
        ...
        {/* // Увеличиваем ширину на lg экранах до ~50% */}
        <Box sx={{ width: { xs: '100%', md: 'calc(50% - 12px)', lg: 'calc(50% - 12px)' } }}> {/* // Адаптивная ширина */}
          <LaborCostDisplay />
        </Box>

        {/* // Отображаем компонент с метриками */}
        {/* // Увеличиваем ширину на lg экранах до ~50% */}
        <Box sx={{ width: { xs: '100%', md: 'calc(50% - 12px)', lg: 'calc(50% - 12px)' } }}>
            <FinancialMetricsDisplay />
         </Box>
         {/* // KeyCharts Box - ADDING HEIGHT HERE */}
         {/* // Устанавливаем ширину 100% на lg, так как он будет переноситься на новую строку */}
         <Box sx={{
           width: { xs: '100%', lg: '100%' },
